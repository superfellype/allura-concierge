    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          isScrolled
            ? "liquid-glass-strong py-3 shadow-lg"
            : "bg-transparent py-5"
        }`}
      >
              ...
              >
                ...
                {cartCount > 0 && (
                  <motion.span
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    className="absolute -top-1 -right-1 w-5 h-5 bg-primary text-primary-foreground text-[10px] font-bold rounded-full flex items-center justify-center shadow-glow"
                  >
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <motion.nav
              ...
              className="absolute top-0 right-0 h-full w-80 max-w-[90vw] liquid-glass-strong p-8 pt-24 shadow-2xl"
            >
