...
export default function EditorCanvas({
  ...
  const { navbar, hero, products, footer, theme } = state;
      ...
      >
        ...
        >
          <section
            ...
            style={{
              minHeight: previewDevice === "mobile" ? "300px" : "450px",
        ...
        <SelectableWrapper
          ...
          onSelect={onSelectElement}
        >
          <section className="py-12 px-6" style={{ backgroundColor: state.benefits.backgroundColor }}>
            <div className={cn(
              "grid gap-6",
              previewDevice === "mobile" ? "grid-cols-1" : `grid-cols-${state.benefits.columns}`
            )}>
              {state.benefits.items.map((item, i) => (
